...
<div
  class=" bg-gradient-to-r from-white to-teal-100 min-h-screen dark:bg-gradient-to-b dark:from-blue-950 dark:via-emerald-900 dark:to-blue-950 dark:bg-fixed"
>
  <Navbar
    let:hidden
    let:toggle
    navClass="border-b-none  bg-gradient-to-r from-white to-teal-100 dark:bg-none dark:bg-blue-950 border-0"
